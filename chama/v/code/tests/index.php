...
try{
    ...
    include $_SERVER['DOCUMENT_ROOT'].'./metavisuo/library.php';
    include $_SERVER['DOCUMENT_ROOT'].'./metavisuo/library.php';
    //
   //Export milk to a database
     include $_SERVER['DOCUMENT_ROOT'].'./export/library.php';
//    include "/export/page_processor.php";
    include $_SERVER['DOCUMENT_ROOT'].'./chama/chama.php';
    //
