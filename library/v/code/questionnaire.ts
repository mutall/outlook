...
type table = {
    ...
    //php Class. For instance, teh whatsapp class was added to support processng
    //of whatsup messages
    class_name:string,
    //
...
//The output from loading a questionnaire is the Imala daa structure.
//The structire is either...
export type Imala = 
  ...
  |{  
        ...
        tables:Array<{
            ...
            errors:number
            //
            //A sample of the top 3 rows to reveal eow based reaults 
            rows:Array<label> 
        }>
   }
//
