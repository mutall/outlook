...
var home_js_1 = __importDefault(require("./home.js"));
//
...
var market = /** @class */ (function (_super) {
    ...
    function market() {
        ...
        _this.school_selector = _this.get_element("search_school");
        // 
        //add event listener to the input selector
        _this.school_selector.onchange = function (evt) { return _this.home.show_school(evt); };
        return _this;
    }
    // 
    //Sets the pannels for now am interested in setting the home pannel
    market.prototype.set_pannels = function () {
        //
        //Create the home pannel
        var Home = new home_js_1.default("#home", this, "general_school");
        // 
        //Set the home pannel;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, market.current.show_panels()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
